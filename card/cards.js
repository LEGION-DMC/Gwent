    ...
    skellige: {
        units: [
            ...
            },
			{
                ...
                strength: 8,
                image: 'sove.mp4',
                description: 'Ярл клана Брокваров',
                descriptionfull: 'Полулегендарный основатель клана Броквар, сын Хеймдалля, играющий важную роль в верованиях островитян.<br><br>Согласно преданиям Сове ― один из сыновей Хеймдалля, страдавший от ссор со своей женой Улулой. Однако ему удалось примириться с ней после паломничества на Хиндарсфьялль и битвы с химерой. Название клана произошло от родового меча Броквар.',
                ability: ' ',
                position: 'close-row',
                rarity: 'silver',
                tags: ['king'],
            },
			{
                ...
                image: 'brokvar.mp4',
                description: ' ',
                descriptionfull: 'Один из семи кланов, контролирующих архипелаг Скеллиге. Занимает остров Спикероог и славится профессиональными пловцами и мастерской подготовкой лучников.',
                ability: 'flock',
				copy: 2,
                position: 'ranged-row',
                rarity: 'bronze',
